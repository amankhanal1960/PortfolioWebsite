    ...
    <div className="container mx-auto px-4 max-w-4xl mb-16">
      ...
      <div className="relative">
        ...
        {items.map((item, idx) => (
          ...
          >
            {/* Circle Bullet */}
            <div className="absolute left-1 sm:left-2 md:left-3 lg:left-4 top-2 w-4 h-4 border-2 border-foreground bg-[#0B1321] rounded-full transform -translate-x-1/2 z-10"></div>
